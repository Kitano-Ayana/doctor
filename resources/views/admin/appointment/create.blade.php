            ...
            <table class="table table-striped">
                <tbody>
                    <tr>
                        ...
                        <td><input type="checkbox" name="time[]" class="form-control" value="12.20pm">12.20pm</td>
                        <td><input type="checkbox" name="time[]" class="form-control" value="12.40pm">12.40pm</td>
                    </tr>
                    <tr>
                        <th scope="row">8</th>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="time[]" class="form-control" value="3.40pm">3.40pm</td>
                    </tr>
                    <tr>
                        <th scope="row">11</th>
                    ...
                    <tr>
                        ...
                        <td><input type="checkbox" name="time[]" class="form-control" value="6.40pm">6.40pm</td>
                    </tr>
                    <tr>
                        <th scope="row">14</th>
                        <td><input type="checkbox" name="time[]" class="form-control" value="7pm">7pm</td>
                        <td><input type="checkbox" name="time[]" class="form-control" value="7.20pm">7.20pm</td>
                        <td><input type="checkbox" name="time[]" class="form-control" value="7.40pm">7.40pm</td>
                    </tr>
