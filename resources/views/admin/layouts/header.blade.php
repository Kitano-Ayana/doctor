...
<html class="no-js" lang="en">
    <head>
        ...
        <script src="/Applications/MAMP/htdocs/doctor/public/template/src/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <button type="button" class="nav-link ml-10" id="apps_modal_btn" data-toggle="modal" data-target="#appsModal"></button>
                            <div class="dropdown">
